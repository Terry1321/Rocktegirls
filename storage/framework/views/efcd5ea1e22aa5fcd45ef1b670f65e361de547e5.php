...
<head>
  ...
  <!-- Jquery -->
  <script src="<?php echo e(asset('./style/home/js/jquery-3.3.1.min.js')); ?>"></script>
  <!-- Bootrstrap CSS -->
  <link rel="stylesheet" href='<?php echo e(asset("./bs/css/bootstrap.min.css")); ?>'>
  <!-- Swiper JS -->
	<link rel="stylesheet" href='<?php echo e(asset("./style/home/css/swiper.min.css")); ?>'>
  <!-- index -->
	<link rel="stylesheet" href="<?php echo e(asset('./style/admin/css/index.css')); ?>">
	<!-- Swiper JS -->
	<script src="<?php echo e(asset('./style/home/js/swiper.min.js')); ?>"></script>
<body>
	<!-- Swiper -->
      ...
      <!-- 左侧菜单栏 -->
        ...
        <ul class="list-unstyled">
          ...
          <a href="javascript:;" id='clear'><li class="list text-center"><span class="glyphicon glyphicon-trash"></span>&nbsp;清理缓存</li></a>
           ...
           <a href="<?php echo e(route('logout')); ?>"onclick="if (confirm('你确定要退出吗?')) {event.preventDefault(); document.getElementById('logout-form').submit();}">
...
// 添加cative
    <?php 
     ...
     ?>
    $('#<?php echo e($active); ?>').addClass('list-active');
